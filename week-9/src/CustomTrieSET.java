...
/**
 * Created by theluxury on 12/15/15.
 */


public class CustomTrieSET implements Iterable<String> {
    private static final int R = 26;        // Just 26 letters. Also, this change requires the next[c] in add and get
    // to become next[c-65] due to char to number conversion. Better for memory.
